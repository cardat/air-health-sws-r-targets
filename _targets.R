...
inputs <-
  list(
    geog = list(
      tar_files(
        infile_geog,
        "~/../cloudstor/Shared/Environment_General//ABS_data/ABS_meshblocks/abs_meshblocks_2016_data_provided/MB_2016_WA.shp",
        format = "file"
      ),
      tar_target(
        tidy_data_geog_part,
      ...
      tar_target(tidy_data_geog, rbind(tidy_data_geog_part))
    ),
    exp_pop = list(
      tar_files(
        infile_exp_pop,
    ...
    exposure = list(
      tar_files(
        infile_exposure,
        "~/../cloudstor/Shared/Environment_General//Air_pollution_model_GlobalGWR_PM25/GlobalGWR_PM25_V4GL02/data_derived/GlobalGWR_PM25_GL_201501_201512-RH35-NoNegs_AUS_20180618.tif",
        format = "file"
      ),
      tar_target(
  ...
  list(
    ...
    tar_target(
      ...
      do_exposures(tidy_data_exposures,
                   tidy_data_geog, tidy_data_exp_pop)
    ),
    tar_target(
...
analysis <-
  list(
    ...
    tar_target(
      ana_attributable_number,
      do_attributable_number(hif = health_impact_function,
