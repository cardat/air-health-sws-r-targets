...
import_globalgwr_pm25_2010_2015 <- function(years){
  ...
  file <- tar_files_input_raw("infile_globalgwr_pm25_2010_2015", sprintf("~/../cloudstor/Shared/Environment_General/Air_pollution_model_GlobalGWR_PM25/GlobalGWR_PM25_V4GL02/data_derived/GlobalGWR_PM25_GL_%s01_%s12-RH35-NoNegs_AUS_20180618.tif", years, years))
